...
const Login = () => {
  ...
  return (
    <div className='w-full h-screen'>
      <img
        className='hidden sm:block absolute w-full h-full object-bottom'
      ...
      <div className='fixed w-full px-4 py-24 z-50'>
        <div className='max-w-[450px] h-[75vh] mx-auto bg-black/75 text-white '>
          <div className='max-w-[320px] mx-auto py-16'>
            <h1 className='text-3xl font-bold'>Sign In</h1>
            {error && <p className='p-3 bg-red-900'>{formatError(error)}</p>}
